...
// limitations under the License.
  ...
  extension Clients {
    ...
    class DataStoreServiceTransport: DataStoreServiceStub {
      ...
      public func createDataStore(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/dataStores"
        }()
        var query = [
      ...
      public func getDataStore(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryengineV1.DataStore.self, from: data)
      }
      ...
      public func listDataStores(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryengineV1.ListDataStoresResponse.self, from: data)
      }
      ...
      public func updateDataStore(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.dataStore.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.data_store.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
