...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SearchTuningServiceTransport: SearchTuningServiceStub {
      ...
      public func trainCustomModel(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):trainCustomModel"
        }()
        let query = [
      ...
      public func listCustomModels(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/customModels"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryengineV1.ListCustomModelsResponse.self, from: data)
      }
