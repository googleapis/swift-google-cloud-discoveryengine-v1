...
// limitations under the License.
  ...
  extension Clients {
    final class GroundedGenerationServiceRetry: GroundedGenerationServiceStub {
      ...
      public init(_ inner: any GroundedGenerationServiceStub, options: GoogleCloudGax.ClientOptions)
      {
        self.inner = inner
      ...
      public func streamGenerateGroundedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: GenerateGroundedContentRequest, o: GoogleCloudGax.RequestOptions) async throws
      ...
      public func checkGrounding(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CheckGroundingRequest, o: GoogleCloudGax.RequestOptions) async throws
