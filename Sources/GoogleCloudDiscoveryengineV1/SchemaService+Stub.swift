...
// limitations under the License.
  ...
  extension Clients {
    ...
    class SchemaServiceTransport: SchemaServiceStub {
      ...
      public func getSchema(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryengineV1.Schema.self, from: data)
      }
      ...
      public func listSchemas(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryengineV1.ListSchemasResponse.self, from: data)
      }
