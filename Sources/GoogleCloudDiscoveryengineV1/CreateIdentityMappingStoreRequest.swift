...
// limitations under the License.
  ...
  ///
  /// [google.cloud.discoveryengine.v1.IdentityMappingStoreService.CreateIdentityMappingStore]: <doc:IdentityMappingStoreService/createIdentityMappingStore(request:)>
