...
// limitations under the License.
  ...
  extension Clients {
    final class ProjectServiceRetry: ProjectServiceStub {
      let inner: any ProjectServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any ProjectServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func provisionProject(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ProvisionProjectRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.provisionProject(request: r, options: o)
          })
      }
