...
// limitations under the License.
  ...
  extension Clients {
    ...
    class IdentityMappingStoreServiceTransport: IdentityMappingStoreServiceStub {
      ...
      public func createIdentityMappingStore(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/identityMappingStores"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryEngineV1.IdentityMappingStore.self, from: data)
      }
      ...
      public func importIdentityMappings(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.identityMappingStore as Swift.String?,
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.identity_mapping_store' is not set or is empty")
          }
          return "/v1/\(pathVariable0):importIdentityMappings"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func purgeIdentityMappings(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):purgeIdentityMappings"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func listIdentityMappings(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):listIdentityMappings"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryEngineV1.ListIdentityMappingsResponse.self, from: data)
      }
      ...
      public func listIdentityMappingStores(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryEngineV1.ListIdentityMappingStoresResponse.self, from: data)
      }
