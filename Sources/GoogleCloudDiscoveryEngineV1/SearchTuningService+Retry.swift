...
// limitations under the License.
  ...
  extension Clients {
    final class SearchTuningServiceRetry: SearchTuningServiceStub {
      ...
      public init(_ inner: any SearchTuningServiceStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func trainCustomModel(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: TrainCustomModelRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func listCustomModels(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListCustomModelsRequest, o: GoogleGax.RequestOptions) async throws
