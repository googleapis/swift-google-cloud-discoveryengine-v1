...
// limitations under the License.
  ...
  extension Clients {
    final class RecommendationServiceRetry: RecommendationServiceStub {
      let inner: any RecommendationServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any RecommendationServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func recommend(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RecommendRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDiscoveryEngineV1.RecommendResponse
            in
            return try await self.inner.recommend(request: r, options: o)
          })
      }
