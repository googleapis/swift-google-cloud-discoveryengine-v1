...
// limitations under the License.
  ...
  extension Clients {
    final class RankServiceRetry: RankServiceStub {
      let inner: any RankServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any RankServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func rank(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RankRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDiscoveryEngineV1.RankResponse
            in
            return try await self.inner.rank(request: r, options: o)
          })
      }
