...
// limitations under the License.
  ...
  extension Clients {
    final class UserLicenseServiceRetry: UserLicenseServiceStub {
      let inner: any UserLicenseServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any UserLicenseServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func listUserLicenses(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListUserLicensesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudDiscoveryEngineV1.ListUserLicensesResponse
            in
            return try await self.inner.listUserLicenses(request: r, options: o)
          })
      }
      ...
      public func batchUpdateUserLicenses(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: BatchUpdateUserLicensesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongRunning.Operation
            in
            return try await self.inner.batchUpdateUserLicenses(request: r, options: o)
          })
      }
