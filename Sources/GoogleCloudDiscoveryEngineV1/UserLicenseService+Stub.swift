...
// limitations under the License.
  ...
  extension Clients {
    ...
    class UserLicenseServiceTransport: UserLicenseServiceStub {
      ...
      public func listUserLicenses(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/userLicenses"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryEngineV1.ListUserLicensesResponse.self, from: data)
      }
      ...
      public func batchUpdateUserLicenses(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):batchUpdateUserLicenses"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
