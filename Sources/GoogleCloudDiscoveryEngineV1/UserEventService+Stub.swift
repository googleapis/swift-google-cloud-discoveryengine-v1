    ...
    class UserEventServiceTransport: UserEventServiceStub {
      ...
      public func writeUserEvent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/userEvents:write"
        }()
        var query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudDiscoveryEngineV1.UserEvent.self, from: data)
      }
      ...
      public func collectUserEvent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/userEvents:collect"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func purgeUserEvents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/userEvents:purge"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func importUserEvents(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/userEvents:import"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
